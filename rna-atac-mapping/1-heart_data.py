...
# rna = rna[rna.obs["donor_id"] == "control_P1"].copy()
# atac = atac[atac.obs["donor_id"] == "control_P1"].copy()
# atac_gene_activity = atac_gene_activity[atac_gene_activity.obs["donor_id"] == "control_P1"].copy()

# After preprocessing, here we use scFUGW.
# print("RNA: \n", rna)
# print("RNA cell types:\n", rna.obs['cell_type'].unique())
# print("ATAC: \n", atac)
# print("ATAC cell types:\n", atac.obs['cell_type'].unique())


# This function will split the data by donor_id, and will add "shareSpace" in atac.obsm
scFUGW.preprocess_rna_atac( rna=rna,
                            atac_peaks=atac,
