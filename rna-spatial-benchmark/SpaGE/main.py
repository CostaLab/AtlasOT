...
def SpaGE(Spatial_data,RNA_data,n_pv,genes_to_predict=None, similarity_threshold=0.3):
    """
        @author: Tamim Abdelaal
    ...
    Effective_n_pv = sum(np.diag(pv_Spatial_RNA.cosine_similarity_matrix_) > similarity_threshold)
